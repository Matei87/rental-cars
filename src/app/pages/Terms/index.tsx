...
const Terms: FC = () => {
  return (
    <Container>
      <FirstTitle>Terms and Conditions</FirstTitle>
      <Paragraph>Welcome to Rentalcars!</Paragraph>
      <Paragraph>
        These terms and conditions outline the rules and regulations for the use
        of Rentalcars's Website, located at Rentalcars.
      </Paragraph>
      <Paragraph>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Rentalcars if you do not agree to
      ...
      <SecondTitle>Cookies</SecondTitle>
      <Paragraph>
        We employ the use of cookies. By accessing Rentalcars, you agreed to use
        cookies in agreement with the Rentalcars's Privacy Policy.
      </Paragraph>
      <Paragraph>
      ...
      <SecondTitle>License</SecondTitle>
      <Paragraph>
        Unless otherwise stated, Rentalcars and/or its licensors own the
        intellectual property rights for all material on Rentalcars. All
        intellectual property rights are reserved. You may access this from
        Rentalcars for your own personal use subjected to restrictions set in
        these terms and conditions.
      </Paragraph>
      <Paragraph>You must not:</Paragraph>
      <UnorderedList>
        <List>Republish material from Rentalcars</List>
        <List>Sell, rent or sub-license material from Rentalcars</List>
        <List>Reproduce, duplicate or copy material from Rentalcars</List>
        <List>Redistribute content from Rentalcars</List>
      </UnorderedList>
      <Paragraph>This Agreement shall begin on the date hereof.</Paragraph>
      <Paragraph>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Rentalcars does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Rentalcars,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Rentalcars shall not be
      ...
      <Paragraph>
        Rentalcars reserves the right to monitor all Comments and to remove any
      ...
      <Paragraph>
        You hereby grant Rentalcars a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
      </Paragraph>
      <SecondTitle>Hyperlinking to our Content</SecondTitle>
      <Paragraph>
      ...
      <UnorderedList>
        ...
        <List>accounting, law and consulting firms; and</List>
      ...
      <Paragraph>
        ...
        the hyperlink compensates the absence of Rentalcars; and (d) the link is
      ...
      <Paragraph>
        ...
        e-mail to Rentalcars. Please include your name, your organization name,
      ...
      <Paragraph>
        No use of Rentalcars's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
      </Paragraph>
      <SecondTitle>iFrames</SecondTitle>
      <Paragraph>
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website.
      </Paragraph>
      <SecondTitle>Content Liability</SecondTitle>
      <Paragraph>
      ...
      <SecondTitle>Your Privacy</SecondTitle>
      <Paragraph>Please read Privacy Policy</Paragraph>
      <SecondTitle>Reservation of Rights</SecondTitle>
      <Paragraph>
      ...
      <SecondTitle>Removal of links from our website</SecondTitle>
      <Paragraph>
      ...
      <SecondTitle>Disclaimer</SecondTitle>
      <Paragraph>
